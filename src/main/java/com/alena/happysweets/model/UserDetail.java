...
/*The CustomUserDetail class is a custom implementation of the UserDetails interface,
which is part of Spring Security.
This class wraps around a User entity and provides additional functionality
required for Spring Security to handle user authentication and authorization.*/
